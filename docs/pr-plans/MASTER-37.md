...
- verifier false/throw both fail closed;
...
- Q7 REQUIRED — exact-head local boundaries/typecheck/focused test.
- Q8 REQUIRED — actual PR diff review and post-Q7 executable-clean compare.
- Q9 BLOCKED until Q7/Q8; then exact-head squash merge and next distribution phase starts from new authoritative `main`.
