...
- `MASTER-31.md` — Canvas Foundation draft/projection contract.
...
Do not start MASTER-32 until MASTER-31 passes exact-head local verification, actual-diff Q8, squash merge and the new authoritative `main` is fetched.
