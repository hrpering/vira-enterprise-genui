...
- `MASTER-34.md` — Canvas deterministic dry-run simulation + replay.
- `ACTIVE_PHASE.md` — machine/human-readable status pointer.

Immediate provenance retained:

- `MASTER-33.md` — merged Canvas AI Co-author proposal/diff gate.
...
Do not start MASTER-35 until MASTER-34 passes exact-head local verification, actual-diff Q8, squash merge and the new authoritative `main` is fetched.
