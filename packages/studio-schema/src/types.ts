...
export type StudioBindingSourceKind = "state" | "domain";

export interface StudioBindingSource {
  readonly kind: StudioBindingSourceKind;
...
export interface StudioInteractionRoute {
...
export interface StudioValidationIssue {
  readonly code: StudioValidationCode;
  readonly path: string;
  readonly message: string;
}

export type StudioExperienceDocumentResult =
