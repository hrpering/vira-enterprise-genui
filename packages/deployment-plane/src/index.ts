...
export type {
  ...
  ViraApplicationDeploymentCommitInput,
  ...
  ViraApplicationDeploymentSourcePrecondition,
  ViraApplicationDeploymentStateStore,
  ViraApplicationDeploymentStoreArtifact,
