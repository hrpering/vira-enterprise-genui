...
export type ViraApplicationExactReferenceParseResult =
...
export type ViraApplicationExactReferenceSerializationResult =
  | {
      readonly ok: true;
      readonly value: string;
      readonly reference: ViraApplicationExactReference;
    }
  | { readonly ok: false; readonly issue: ViraApplicationPackageValidationIssue };
...
export function parseViraApplicationExactReference(
  input: unknown,
): ViraApplicationExactReferenceParseResult {
  ...
  if (
    ...
    return fail("INVALID_REFERENCE", "$", "reference shape is invalid");
  }
...
export function serializeViraApplicationExactReference(
  input: unknown,
